...
export class SideMenu {
  ...
  @Prop({ mutable: true }) ariaExpanded: string = '';
  ...
  @Watch('ariaExpanded')
  expandedHandler(newValue: string) {
    ...
    return (
      <div role="menuitem">
        <a
          ...
          aria-expanded={this.hasChildren ? this.ariaExpanded.toString() : this.ariaExpanded}
          onClick={e => this.handleClick(e)}
          style={{ paddingLeft: leftIndent }}
        >
          <span>
            {this.iconclass && <i class={this.iconclass}></i>}
            {this.label}
          </span>
        </a>
